...
namespace SKBKontur.Catalogue.CassandraPrimitives.NewRemoteLock.WithExpirationService.QueueStorage
{
    ...
    {
        public QueueStorage(ITimeServiceClient timeServiceClient, IMetaStorage metaStorage, ICassandraCluster cassandraCluster, ISerializer serializer, RemoteLockSettings lockSettings)
        {
