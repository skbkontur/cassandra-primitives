...
namespace SKBKontur.Catalogue.CassandraPrimitives.Tests.RemoteLockBenchmark.Infrastructure.ChildProcessDriver
{
    public class ChildExecutableGenerator
    {
        public static void Generate(string outputDir, Func<IScenariosRegistry> registryCreator)
        {
            ...
            var codeNamespace = new CodeNamespace("SKBKontur.Catalogue.CassandraPrimitives.Tests.RemoteLockBenchmark.Infrastructure.ChildProcessDriver.ChildExecutable");
            codeNamespace.Imports.Add(new CodeNamespaceImport("System"));
            codeNamespace.Imports.Add(new CodeNamespaceImport("SKBKontur.Catalogue.CassandraPrimitives.Tests.RemoteLockBenchmark"));
            codeNamespace.Imports.Add(new CodeNamespaceImport("SKBKontur.Catalogue.CassandraPrimitives.Tests.RemoteLockBenchmark.Infrastructure.Registry"));
            ...
            var run = new CodeMethodInvokeExpression(
                new CodeTypeReferenceExpression("SKBKontur.Catalogue.CassandraPrimitives.Tests.RemoteLockBenchmark.Infrastructure.ChildProcessDriver.ChildExecutableGenerator"),
                "Run",
