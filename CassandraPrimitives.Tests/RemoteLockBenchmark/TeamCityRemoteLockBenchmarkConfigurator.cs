        ...
        public void Run()
        {
            ...
            try
            {
                ...
                ManyOptionsBenchmarkConfigurator
                    ...
                    .WithExistingCassandraCluster(new CassandraClusterSettings("test_cluster", new[]
                        {
                            new IPEndPoint(IPAddress.Parse("10.217.9.2"), 9160),
                            new IPEndPoint(IPAddress.Parse("10.217.8.243"), 9160),
                            new IPEndPoint(IPAddress.Parse("10.217.8.242"), 9160),
                        }, new IPEndPoint(IPAddress.Parse("10.217.9.2"), 9160)), new CassandraMetaProvider())
                    .WithJmxTrans(JmxGraphitePrefix, new[]
                        {
                            Tuple.Create("load01nixcat.dev.kontur.ru", 7199),
                            Tuple.Create("load02nixcat.dev.kontur.ru", 7199),
                            Tuple.Create("load03nixcat.dev.kontur.ru", 7199),
                        })
                    .WithSetUpAction(() =>
                        {
